...
type OrderHistoriesUsecase struct {
	repo   domain.OrderHistoriesRepository
	mapper domain.OrderHistoriesMapper
}

// NewOrderHistoriesUsecase creates a new instance of OrderHistoriesUsecase
func NewOrderHistoriesUsecase(repo domain.OrderHistoriesRepository, mapper domain.OrderHistoriesMapper) domain.OrderHistoriesUsecase {
